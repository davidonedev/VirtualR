...
const Workflow = () => {
  return (
    <div className="mt-20 ">
        <h2 className=" text-2xl sm:text-5xl lg:text-6xl text-center 
        mt-6 tracking-wide mt-6"> O que você leva ao alugar <br/>um 
        ...
        <div className="flex flex-wrap justify-center">
            ...
            <img src={codeImg} className="w-[430px] mt-14 rounded-2xl shadow-2xl 
            shadow-blue-500/20 xl:ml-24" alt="Code" />
            </div>
