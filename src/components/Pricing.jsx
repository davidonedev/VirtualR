...
const Pricing = () => {
  return (
    <div id="precos" className="my-8 border-t border-zinc-700/50 xl:mb-40 2xl:mt-16 2xl:mb-10">
      ...
      <div className="flex items-center justify-center min-h-screen flex-col sm:flex-row 
        ...
        "Perfeito para eventos e festas"]
          ...
          <div key={index} className="relative rounded-3xl bg-gray-700 bg-opacity-25 p-8 ring-1 shadow-2xl ring-gray-900/10 sm:p-10 xl:w-2/5">
            ...
            <a href="#" className="mt-8 block rounded-md bg-indigo-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-indigo-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 sm:mt-10">Assinar plano</a>
          </div>
        ))}
      </div>
    </div>
