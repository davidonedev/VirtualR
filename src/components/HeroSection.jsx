  ...
  return (
    <div className="flex justify-center items-center w-full min-h-screen">
        <div className="flex flex-col items-center mx-auto text-center">
            <h1 className="text-slate text-4xl sm:text-4xl lg:text-6xl tracking-wide md:mt-10">
            ...
            <p className="mt-5 text-lg text-neutral-500 max-w-4xl">
            ...
            <a href="#" className="bg-gradient-to-r bg-violet-800 py-3 px-4 mx-3 rounded-md">Adquira agora!</a>
            </div>
